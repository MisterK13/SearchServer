...
int SearchServer::GetDocumentId(int index) const
{
    ...
    {
        return documents_index_[static_cast<size_t>(index)];
    }
    else
    {
...
{
    using namespace std;
    return log(GetDocumentCountNoLock() * 1.0 / static_cast<double>(word_to_document_freqs_.at(word).size()));
}
